  ...
  return (
    <div className='min--h-[550px] flex items-center justify-center py-12'>
       <div className='container'>
          <div  style={{ backgroundColor: data.bgColor }} className='grid grid-cols-1 md:grid-cols-3 items-center rounded-3xl text-white gap-6'>
            {/* first col */}
            ...
            <div data-aos="zoom-in" className='h-full flex items-center'>
              <img src={data.image} alt="img" className='scale-125 w-[250px] md:w-[350px] mx-auto drop-shadow-2xl object-cover'  />
            </div>
            {/* third col */}
            <div className='flex flex-col justify-center gap-4 p-6 sm:p-8'>
              <p data-aos="zoom-out" className='font-bold texl-xl'>{data.title2}</p>
